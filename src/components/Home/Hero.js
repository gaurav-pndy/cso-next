...
export default function Hero() {
  return (
    <section className="relative md:flex items-center px-4 min-h-screen md:min-h-[40rem] lg:min-h-[50rem] xl:min-h-screen bg-gray-50 overflow-hidden pb-10 md:pb-0">
      {/* Background Image */}
      ...
      <section className="max-w-7xl  w-full mx-auto">
        <div className="relative  z-20 flex flex-col max-w-2xl pt-28 lg:pt-10">
          ...
          <div className="flex flex-col md:flex-row space-y-2 space-x-10">
            <Link
              href="/submit"
              className="bg-[#2eabb8] cursor-pointer w-full hover:bg-cyan-600 text-white py-3.5 px-6 rounded-lg font-semibold transition-all duration-300  focus:outline-none flex justify-center"
            >
              Submission
            </Link>
            <Link
              href="/story"
              className="bg-[#eb6747] text-white w-full cursor-pointer hover:bg-[#e8532e] py-3.5 px-6 rounded-lg font-semibold flex justify-center items-center transition-all duration-300 focus:outline-none"
            >
