...
export default function ImpactSection() {
  return (
    <section className="flex justify-center  py-10 px-4">
      <div className="flex flex-col md:flex-row gap-10 items-center md:items-center w-full max-w-3xl md:max-w-6xl rounded-3xl overflow-hidden bg-linear-to-tr from-[#0061e5] via-[#0061e5] via-20% to-[#e1740d] p-4 md:p-12 shadow-lg">
