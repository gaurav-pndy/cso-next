...
export const metadata = {
  title: "Terms and Conditions | Centre for Scientific Outreach",
  description:
    ...
    <main className="py-16 px-4 relative mt-20">
      <section className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center mb-12 md:text-xl">
          This agreement describes your rights and responsibilities with regards
          to use of CSO website. <br />
        ...
        <section className="space-y-10 text-sm md:text-base leading-7 text-gray-800">
          <div>
            ...
            <div className="space-y-2">
              <p>
                ...
                limitation, together with all other websites operated by CSO
                group of Companies and (b) any and all information available on
                the Website, including, data, text, software, sound,
                photographs, graphics, video, messages, and other materials
                ("Content").
              </p>
              <p>
                You must read the Terms carefully. CSO provides the Website to
                you subject to the Terms. The Terms are entered into by and
                between you and CSO, and you accept them by using the Website in
                any manner. If you do not agree to all of the Terms, do not use
                the Website.{" "}
              </p>
              <p>
                ...
                redistribution, re-transmission, commercial exploitation, or
                other uses of the Website or the Content are strictly
                prohibited.
              </p>
              <p>
                {" "}
                CSO makes no representation that the Website or the services
                available through the Website are appropriate or available for
                use in all locations. The Website and CSO products and services
          ...
          <div>
            <h2 className="font-semibold text-xl mb-2">
              2. Notices; Modification and Termination of Services; Amendment of
              the Terms
            </h2>
            <div className="space-y-2">
              <p>
                CSO may provide notice to you regarding changes to the Website
                or these Terms via e-mail, regular mail, or posting notices or
                links to notices on the Website. CSO reserves the right at any
                time in its sole discretion to modify, suspend or terminate the
                services provided through the Website (or any part thereof), and
                / or your use of or access to them, with or without notice. CSO
                may also delete, or bar access to or use of, all related Content
                and files.{" "}
              </p>
              <p>
                CSO will not be liable to you or any third-party for any
                modification, suspension or termination of the services or
                Content provided through the Website, or loss of related
                information. You have sole responsibility for adequate
                protection and backup of data and / or equipment used in
                connection with the Website.{" "}
              </p>
              <p>
                CSO may amend these Terms at any time by posting the amended
                terms on the Website.
              </p>
              <p>
                If you are dissatisfied with the services provided through the
                Website, your sole and exclusive remedy is to discontinue your
                use of the Website.
              </p>
            </div>
          </div>
          ...
          <div>
            <h2 className="font-semibold text-xl mb-2">3. Registration Data</h2>
            <div className="space-y-2">
              <p>
                ...
                information accurate, current, and complete; and <br />
                (d) accept all risks of unauthorized access to all such
                information. You further consent and authorize us to verify your
                Registration Data.{" "}
              </p>
              <p>
                CSO's use and disclosure of your Registration Data is governed
                by CSO's Privacy Policy.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p>
                You agree that you will not use the Website to: <br />
                (A) transmit spam, bulk or unsolicited communications; <br />
                ...
                Website unless specifically authorized by such users. <br />{" "}
              </p>
              <p>
                In using the interactive features of the Website, you agree not
                to upload, post or otherwise transmit via the Website Content
                that: (A) is inaccurate, harmful, obscene, pornographic,
                defamatory, racist, violent, offensive, or harassing; causes
                duress, distress, or discomfort to another; or is otherwise
                objectionable to CSO or other users of the Website; <br />
                ...
                or against any candidate for public office; or <br />
                ...
                right to edit or remove any Content from the Website at any
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                routines or engines that are intended to damage, destroy,
                disrupt or otherwise impair a computer's functionality or
                operation.
              </p>
              <p>
                CSO will investigate occurrences which may involve violations of
                system or network security and may involve and may cooperate
          ...
          <div>
            ...
            <div className="space-y-2">
              <p>
                You expressly agree that CSO has no responsibility for or
                control over the Content that you or other Website users upload,
                post or otherwise transmit via the Website. CSO makes no
                representation that your use of the Website will comply with
                applicable laws. Additionally, we do not represent, warrant or
                guarantee the truthfulness, accuracy, quality or reliability of
                any of the Content posted, displayed, linked to or otherwise
                transmitted via the Website.{" "}
              </p>
              <p>
                We also do not endorse any opinions expressed in or through any
                Content available on the Website. You agree that you must
                evaluate and bear all risks associated with your use of any
              ...
              <p>
                ...
                REPRESENTATIONS, AND WARRANTIES OF ANY KIND, INCLUDING ANY
                IMPLIED WARRANTY OR CONDITION OF MERCHANT-ABILITY, SATISFACTORY
                QUALITY, FITNESS FOR A PARTICULAR PURPOSE OR NON-INFRINGEMENT.
                CSO MAKES NO REPRESENTATIONS, WARRANTIES, CONDITIONS OR
                GUARANTEES AS TO THE USEFULNESS QUALITY, SUITABILITY, TRUTH,
              ...
              <p>
                ...
                (b) THE RESULTS THAT MAY BE OBTAINED FROM THE USE OF THE WEBSITE
                WILL BE ACCURATE OR RELIABLE; (c) THE QUALITY OF ANY PRODUCTS,
                SERVICES, CONTENT, INFORMATION OR OTHER MATERIAL PURCHASED OR
                OBTAINED FROM THE WEBSITE WILL MEET YOUR EXPECTATIONS OR
                REQUIREMENTS; OR (d) ANY ERRORS ON THE WEBSITE WILL BE
                CORRECTED.{" "}
              </p>
              <p>
                YOU ASSUME ALL RISK FOR ANY DAMAGE TO YOUR COMPUTER SYSTEM OR
                LOSS OF DATA THAT RESULTS FROM OBTAINING ANY CONTENT FROM THE
                WEBSITE, INCLUDING ANY DAMAGES RESULTING FROM COMPUTER VIRUSES.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p>
                ...
                legal advice and is not intended for use in the practical
                business / Aviation conditions. The Content is not comprehensive
                and should not be used as a substitute for consultation with a
                licensed Aviation professional or other traditional source of
                Aviation information. The mention of any product, service,
                organization, activity, or therapy on the Website should not be
                construed as an CSO endorsement. CSO assumes no responsibility
                for any injury or damage to persons or property arising out of
                or related to the Content of the Website.
              </p>
              <p>
                TO THE FULLEST EXTENT PERMITTED BY LAW, CSO DISCLAIMS AND WILL
                NOT BE LIABLE FOR ANY DIRECT, INDIRECT, PUNITIVE, SPECIAL,
                ...
                ECONOMIC ADVANTAGE) ARISING OUT OF OR IN CONNECTION WITH THE
                WEBSITE, EVEN IF CSO HAS PREVIOUSLY BEEN ADVISED OF, OR
                ...
                (INCLUDING NEGLIGENCE), INCLUDING WITHOUT LIMITATION DAMAGES DUE
                TO: (a) THE USE OF OR THE INABILITY TO USE THE WEBSITE; (b) THE
                ...
                THROUGH, OR FROM THE WEBSITE; (c) STATEMENTS OR CONDUCT OF ANY
                THIRD PARTY ON THE WEBSITE, INCLUDING WITHOUT LIMITATION
                UNAUTHORIZED ACCESS TO OR ALTERATION OF TRANSMISSIONS OR DATA,
                MALICIOUS OR CRIMINAL BEHAVIOR OR FALSE OR FRAUDULENT
                TRANSACTIONS; OR (d) CONTENT OR INFORMATION YOU MAY DOWNLOAD,
              ...
              <p>
                ...
                as a result of your use of the Website, or are in any way
                damaged as a result of any third party in connection therewith,
                you hereby release and covenant not to sue or otherwise make a
                claim, demand or file any legal action or institute any legal or
                regulatory proceedings against us, our affiliates, officers,
                directors, employees, agents, representatives and suppliers
                from, for any claims, actions, demands or damages (whether
                direct, indirect , special, incidental or consequential), of
                whatever kind or nature, known or unknown, suspected or
                unsuspected, whether foreseeable or not, disclosed or
                undisclosed.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p>
                ...
                mirror, frame, republish, download, transmit or create
                derivative works of the Content, in whole or in part, by any
                means. You must not modify, de-compile or reverse engineer any
                software CSO discloses to you, and you must not remove or modify
              ...
              <p>
                ...
                estoppel, implication or otherwise. You may not do or allow
                anyone else to do anything with the Content which is not
                specifically permitted under the Terms. Permission is granted to
                display, copy, distribute, and download Content owned by CSO on
                this Website provided that: (a) the copyright notice pertaining
                to the Content remains, and a permission notice (eg, "Used with
                permission") is added to such Content; (b) the use of such
                Content is solely for personal informational and educational use
                and not for commercial purposes, and is not used to imply that
                CSO endorses, sponsors or is affiliated with any product or
                service; (c) such Content will not be copied or posted on any
                networked computer or published in any medium, except as
                explicitly permitted by valid permission or license covering
                such materials; and (d) no modifications are made to such
                Content. This permission terminates automatically without notice
                if you breach any of the terms or conditions in these Terms.
              ...
              <p>
                ...
                alter any CSO Trademark, or co-brand your own products or
                material with CSO Trademark, without CSO 's prior written
                consent, which can be granted or denied at CSO' s sole
                discretion. You acknowledge CSO 's rights in the CSO Trademark,
                and you agree not to incorporate any CSO Trademark into your
                trademarks, service marks, company names, Internet addresses,
                domain names or any other similar designations, for use on or in
                connection with your or any third party's products, services or
                information.
              </p>

              <p>
                CSO does not claim ownership of any content that you place on
                the Website and shall have no obligation of any kind with
                respect to such content. Any content that you provide in
                connection with this Website shall be deemed to be provided on a
                non-confidential basis. CSO shall be free to use, reproduce,
                modify, publish and / or disseminate such content on an
                unrestricted basis for any purpose, and you grant CSO and all
                other users of the Website an irrevocable, perpetual, worldwide,
                royalty-free, transferable, nonexclusive license to use,
                reproduce, modify, distribute, transmit, display, perform,
                adapt, resell, and publish such content (including in digital
                form). You represent and warrant that you have proper
                authorization for the worldwide transfer and processing among
                CSO, its affiliates, and third-party vendors of any information
                or content that you may provide to CSO through the Website.
              </p>
            </div>
          </div>
          ...
          <div>
            <h2 className="font-semibold text-xl mb-2">
              10. Identification of Authorised Representation for Receipt of
            ...
            <div className="space-y-2">
              <p>
                ...
                claimed copyright infringement to CSO's authorised
                Representative:
              </p>
              ...
              <div>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>
                    ...
                    infringing is located on the Website, including but not
                    limited to the URL.
                  </li>
          ...
          <div>
            <h2 className="font-semibold text-xl mb-2">
              11. Confidentiality of CSO Information
            </h2>
            <div className="space-y-2">
              <p>
                ...
                confidence. Title to Confidential Information remains with CSO
                and any third-party providers of Confidential Information. Upon
                termination of the Terms or CSO's written request, you must
              ...
              <p>
                ...
                sufficient evidence: (a) you possessed prior to your receipt
                from CSO, without an obligation to maintain its confidentiality;
                (b) is or becomes generally known to the public through no act
                or omission by you, or otherwise without violation of the Terms;
                (c) you obtained from a third party who had the right to
                disclose it, without an obligation to keep such information
                confidential; or (d) you independently developed without the use
                of Confidential Information and without the participation of
                individuals who have had access to Confidential Information. In
                addition, if, in response to a valid order by a court or other
                governmental body, as otherwise required by law, or as necessary
                to establish the rights of either party under these Terms, you
                are required to disclose Confidential Information, then you may
                do so, but only to the minimum extent required and only after
                prior notice to CSO adequate to afford CSO the opportunity to
          ...
          <div>
            <h2 className="font-semibold text-xl mb-2">12. Indemnity</h2>
            <div>
          ...
          <div>
            <h2 className="font-semibold text-xl mb-2">16. General Terms</h2>
            <div>
              <p>
                {" "}
                Services, Content, and products derived or obtained from this
                Website may be subject to the export laws of the Republic of
                India and the export or import laws of other countries. You
                agree to comply strictly with all such laws and, in particular,
                shall: <br />
                (a) obtain any export, reexport or import authorizations
                required by the Republic of India or your local laws; <br />
                (b) not use Services, Content or products from this Website to
                design, develop or produce missile, chemical / biological, or
                nuclear weaponry; and <br />
              ...
              <p>
                ...
                prior versions of the Terms. No modification to the Terms will
                be binding, unless in writing and signed by an authorized CSO
              ...
              <p>
                You agree that any material breach of Sections 4, 5, 8, and 10
                of the Terms will result in irreparable harm to CSO for which
                damages would be an inadequate remedy and, therefore, in
                addition to its rights and remedies otherwise available at law ,
                CSO will be entitled to equitable relief, including both a
                preliminary and permanent injunction, if such a breach occurs.
                You waive any requirement for the posting of a bond or other
                security if CSO seeks such an injunction.
              </p>
              ...
              <p>
                ...
                the appropriate contact, listed below: <br />
                  Centre for Scientific Outreach <br />
                Praveen Sankaran <br />
                E-mail: hello@thecso.in
              </p>
              ...
              <p>
                ...
                construed, and enforced solely and exclusively in accordance
                with the law of the Republic of India, without regard to
                conflicts of law provisions thereof. You agree that exclusive
                jurisdiction and venue of any dispute with CSO or its licensors,
                or any of their respective affiliates, officers, directors,
                employees, contractors, agents, representatives or suppliers,
                arising out of or in any way relating to the Terms or your use
                of or inability to use the Website, services, or Content shall
                reside in the Central and state courts serving the Republic of
                India. You expressly consent to the exercise of personal
                jurisdiction by such courts and agree that you will not object
                to jurisdiction of or venue in such courts on the grounds of
                lack of personal jurisdiction, forum non convenience, or
                otherwise.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p>
              {/* Paste the contact block (organisation name, contact person, email) here. */}
            </p>
          </div>
        </section>
      </section>
